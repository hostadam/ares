...
import io.github.hostadam.api.command.tabcompletion.TabCompletionMapper;
import io.github.hostadam.command.context.CommandContext;
import io.github.hostadam.command.context.CommandContextHelper;
import io.github.hostadam.command.context.CommandExecutionException;
import io.github.hostadam.api.command.tabcompletion.TabCompletions;
...
public class AresCommandData {
    ...
    public AresCommandData(CommandRegistry handler, String[] labels, String description, String usageMessage, String permission, boolean sendUsagePrioritized, Method method, Object object) {
