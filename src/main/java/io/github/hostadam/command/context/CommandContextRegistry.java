...
public class CommandContextRegistry {
    ...
    public <E extends Enum<E>> Optional<E> parseEnum(Class<E> clazz, String value) {
        try {
            String upper = value.toUpperCase();
            E parsed = Enum.valueOf(clazz, upper);
